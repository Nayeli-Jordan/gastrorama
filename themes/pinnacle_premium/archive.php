<?php get_header(); 
  ...
  if(kadence_display_sidebar()) {$display_sidebar = true; $fullclass = '';} else {$display_sidebar = false; $fullclass = 'fullwidth';}
  global $pinnacle, $postcolumn; 
  if(isset($pinnacle['blog_cat_infinitescroll']) && $pinnacle['blog_cat_infinitescroll'] == 1) {$infinitescroll = true;} else {$infinitescroll = false;}
