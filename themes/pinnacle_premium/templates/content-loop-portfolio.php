                      ...
                      if ($attachments) {
                        foreach ($attachments as $attachment) {
                          ...
                          if(empty($kt_portfolio_loop['slideheight'])) {$slide_height = $kt_portfolio_loop['slidewidth'];} else {$slide_height = $kt_portfolio_loop['slideheight'];}
                            ...
                            if(empty($image[0])) {$image = array($thumbnailURL,$kt_portfolio_loop['slidewidth'],$slide_height);} 
                             ?>
                              <li>
                                <a href="<?php the_permalink() ?>" class="portfolio_slider_link">
                                  <img src="<?php echo esc_url($image[0]); ?>" width="<?php echo esc_attr($image[1]); ?>" height="<?php echo esc_attr($image[2]); ?>" <?php echo kt_get_srcset_output($image[1], $image[2], $thumbnailURL, $attachment);?> class="portfolio_img_slider portfolio_img" />
                  ...
                  <div class="portfolio-imagepadding kt-portfolio-video">
                    <div class="portfolio-hoverclass">
                      <a href="<?php the_permalink() ?>" class="">
                          <img src="<?php echo esc_url($image[0]); ?>" width="<?php echo esc_attr($image[1]); ?>" height="<?php echo esc_attr($image[2]); ?>" <?php echo kt_get_srcset_output($image[1], $image[2], $thumbnailURL, $image_id);?> alt="<?php the_title(); ?>" class="kad-lightboxhover">
                            <div class="portfolio-hoverover"></div>
                            <div class="portfolio-table">
                              <div class="portfolio-cell">
                                  <?php if($kt_portfolio_loop['pstyleclass'] == "padded_style" ) { ?>
