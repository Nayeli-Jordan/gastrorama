                      ...
                      if(empty($image[0])) {$image = array($thumbnailURL,$image_width,$image_height);}
                                  ...
                                  <div class="imghoverclass img-margin-center" itemprop="image">
                                    <a href="<?php the_permalink()  ?>" title="<?php the_title(); ?>">
                                      <img src="<?php echo esc_url($image[0]); ?>" alt="<?php the_title(); ?>" <?php echo 'width="'.esc_attr($image[1]).'" height="'.esc_attr($image[2]).'"';?> <?php echo kt_get_srcset_output( $image[1], $image[2], $thumbnailURL, $image_id);?> class="iconhover" style="display:block;">
                                    </a> 
                                  </div>
