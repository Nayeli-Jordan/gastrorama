...
function kadence_register_required_plugins() {
	 ...
	 */
	if(isset($pinnacle['kt_revslider_notice']) && $pinnacle['kt_revslider_notice'] == 1) {
			$addons[] = array(
				'name'     				=> 'Revolution Slider',
				'slug'     				=> 'revslider',
				'source'   				=> 'https://s3.amazonaws.com/ktupdates/api/524561603141589/revslider.zip',
				'required' 				=> false,
				'version' 				=> '5.2.3',
	...
	if(isset($pinnacle['kt_cycloneslider_notice']) && $pinnacle['kt_cycloneslider_notice'] == 1) {
			$addons[] = array(
	...
	if(isset($pinnacle['kt_kadenceslider_notice']) && $pinnacle['kt_kadenceslider_notice'] == 1) {
			$addons[] = array(
