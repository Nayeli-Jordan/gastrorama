...
function kadence_display_sidebar() {
   if (class_exists('woocommerce'))  {
        ...
        array('kadence_sidebar_on_shop_page','kadence_sidebar_page_woo', 'kadence_sidebar_on_product_post','kadence_sidebar_on_archive_page','kadence_sidebar_on_shop_cat_page','kadence_sidebar_on_post','is_404','kadence_sidebar_on_home_page','kadence_sidebar_on_myaccount_page','is_cart','is_checkout',array('is_singular', array('portfolio')),array('is_singular', array('kadslider')), array('is_singular', array('attachment')), array('is_tax', array('portfolio-type'))
        ),
        array('template-portfolio-grid.php','template-contact.php')
      );
  } else {
  $sidebar_config = new Kadence_Sidebar(
    array('kadence_sidebar_page', 'kadence_sidebar_on_post','is_404','kadence_sidebar_on_archive_page_noshop','kadence_sidebar_on_home_page', array('is_singular', array('portfolio')), array('is_singular', array('kadslider')), array('is_singular', array('attachment')), array('is_tax', array('portfolio-type'))
      ),
    array('template-portfolio-grid.php','template-contact.php' )
  );
}
